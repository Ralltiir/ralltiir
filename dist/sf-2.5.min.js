...
}function e(t,r){return a&&t.equal(a)&&!r.force}function n(t){var r=p.root;if("/"===t.charAt(0)&&r)if(0===t.indexOf(r))t=t.replace(r,"");else{var e=r.split("/").slice(1);e=e.map(function(){return".."}),t=e.join("/")+t,a=null}return t}function o(t,r){return t||(t=n(location.pathname)),new c(t,{query:r,base:a})}function i(t,e){t=t||{};var i=n(location.pathname);if(location.search.length>1&&(i+=location.search),i=o(i),i.outRoot)return u(i.toString(),!0);var s=e?{src:"sync"}:f({},t.state,{src:"back"});
...
}function a(r){var e=t(arguments);return S.split.apply(r||"",e)}function f(r){return t(arguments).reduce(function(t,r){return t.replace("%s",r)},r)}function c(){return l.apply(null,u(arguments,0).reverse())}function p(t){return null!==t&&"object"==typeof t}function h(t){return t instanceof String||"string"==typeof t}function l(t){t=null==t?{}:t;var r=u(arguments,1);return o(r,function(r){g(t,r)}),t}function d(t,r){return t?void e(r,function(r,e){return p(r)&&p(t[e])?d(t[e],r):void(t[e]=r)}):t}function g(t,r){return t?(e(r,function(r,e){t[e]=r
}),t):t}function y(){var t={},r=u(arguments,0).reverse();return o(r,function(r){d(t,r)}),t}function m(t){var r={};return i(t,function(t){var e=t[0],n=t[1];r[e]=n}),r}function v(t){return t instanceof Array}function w(t){return v(t)?0===t.length:!t}function b(t){return function(){return!t.apply(null,arguments)}}function q(t){var r=u(arguments);return function(){var e=[0,0];e.push(r);var n=_.splice.apply(arguments,e);return t.apply(null,n)}}function A(t){var r=u(arguments);return r.shift(),function(){var e=u(arguments),n=[e,arguments.length,0].concat(r);
return s.apply(null,n),t.apply(null,e)}}var j={},_=Array.prototype,S=(Object.prototype,String.prototype);return j.keysIn=r,j.forOwn=e,j.assign=l,j.merge=l,j.extend=l,j.defaults=c,j.defaultsDeep=y,j.fromPairs=m,j.slice=u,j.splice=s,j.forEach=o,j.map=i,j.toArray=n,j.split=a,j.format=f,j.isArray=v,j.isEmpty=w,j.isString=h,j.isObject=p,j.partial=q,j.partialRight=A,j.negate=b,j}),define("sfr/utils/promise",["require","sfr/utils/underscore"],function(t){function r(t){if(!(this instanceof r))throw"Promise must be called with new operator";
...
})},r.all=function(t){return new r(function(e,n){var o=t.map(function(){return void 0}),i=0;t.map(r.resolve).forEach(function(r,u){r.then(function(r){o[u]=r,i++,i===t.length&&e(o)},n)})})},r.mapSeries=function(t,e){var n=r.resolve("init"),o=[];return t.forEach(function(r,i){n=n.then(function(){return e(r,i,t)}).then(function(t){return o.push(t)})}),n.then(function(){return o})},r}),define("sfr/action",["require","sfr/router/router","sfr/utils/promise","sfr/utils/underscore"],function(t){function r(t){return"object"==typeof t&&t.create&&t.attach&&t.detach&&t.destroy&&t.update?!0:!1
}function e(t,r){var e=r.getAttribute("data-sf-href"),n=r.getAttribute("data-sf-options");if(e){try{n=JSON.parse(n)||{}}catch(o){n={}}n.src="hijack",s.redirect(e,null,n),t.preventDefault()}}function n(t){function r(t,r){for(var e=t;null!==e&&e.tagName!==r.toUpperCase();)e=e.parentNode;return e}document.documentElement.addEventListener("click",function(e){e=e||window.event;var n=r(e.target||e.srcElement,"A");n&&t(e,n)},!1)}var o,i=t("sfr/router/router"),u=t("sfr/utils/promise"),s=(t("sfr/utils/underscore"),{}),a={};
return s.regist=function(t,e){if(!t)throw new Error("illegal action name");if(!e)throw new Error("illegal action option");!a.hasOwnProperty(t)&&r(e)&&(i.add(t,this.dispatch),a[t]=e)},s.dispatch=function(t,r){var e=a[t.path],n=a[r.path];return t.options=t.options||{},u.mapSeries([n&&n.detach.bind(n),e&&e.create.bind(e),r.url!==o&&n&&n.destroy.bind(n),e&&e.attach.bind(e)],function(e){return"function"==typeof e?e(t,r):void 0}).catch(function(t){console.error("Unable to switch service",t.stack)})},s.remove=function(t){a.hasOwnProperty(t)&&delete a[t]
},s.exist=function(t){return a.hasOwnProperty(t)},s.clear=function(){a={},i.clear()},s.redirect=function(t,r,e){i.redirect(t,r,e)},s.back=function(){history.back()},s.reset=function(t,r,e){i.reset(t,r,e)},s.start=function(){n(e)},s.update=function(t,r,e,n){e=e?e:{},e.hasOwnProperty("silent")||(e.silent=!0);var o=location.href.replace(/.*\/([^\/]+$)/,"/$1"),u=location.pathname.replace(/.*\/([^\/]+$)/,"/$1");if(a.hasOwnProperty(u)){var s=a[u];s.update({path:u,url:t,prevUrl:o,query:r,options:e,container:n.container,view:n.view})
}i.reset(t,r,e)},s}),define("sfr/service",["require"],function(){var t=function(){};return t.prototype.create=function(){},t.prototype.attach=function(){},t.prototype.detach=function(){},t.prototype.destroy=function(){},t.prototype.update=function(){},t}),define("sfr/resource",["sfr/utils/http","sfr/utils/underscore"],function(t,r){function e(t){this.url=t}return e.prototype={getUrl:function(t){var e=this.url;return r.forOwn(t,function(t,r){e=e.replace(":"+r,t)}),e=e.replace(/:\w+/g,"")},create:function(r,e){var n=this.getUrl(e);
