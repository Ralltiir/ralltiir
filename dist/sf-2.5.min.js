...
},r.setMaxListeners=function(t){return this.maxListeners=t,this};var e=Object.keys(r);return t.mixin=function(t){for(var n,o=0,i=e.length;i>o;o++)n=e[o],t[n]=r[n];return t},t}),define("sfr/router/router/URL",["require","sfr/router/uri/component/Path","sfr/router/uri/component/Query","sfr/router/uri/component/Fragment","sfr/router/router/config"],function(t){function r(t,r){r=r||{},t=(t||"").trim()||i.path;var a=u.exec(t);a||console.warn("URI not valid:");var f=this.token=r.token||s,c=r.root||i.root;
"/"===c.charAt(c.length-1)&&(c=c.substring(0,c.length-1)),this.root=c,t=t.split("#"),this.fragment=new o(t[1]),t=t[0].split(f);var p=r.base||{};this.path=new e(t[0],p.path),this.query=new n(t[1]);var h=this.path.get();this.outRoot=0===h.indexOf(".."),this.outRoot&&(h=e.resolve(c+"/",h),0===h.indexOf(c)&&(h=h.substring(c.length),this.path.set(h),this.outRoot=!1)),this.outRoot||"/"===h.charAt(0)||this.path.set("/"+h),r.query&&this.query.add(r.query)}var e=t("sfr/router/uri/component/Path"),n=t("sfr/router/uri/component/Query"),o=t("sfr/router/uri/component/Fragment"),i=t("sfr/router/router/config"),u=new RegExp("^(([^:/?#]+):)?(//([^/?#]*))?([^?#]*)(\\?([^#]*))?(#(.*))?"),s="?";
return r.prototype.toString=function(){var t=this.root,r=this.path.get();return r=this.outRoot?e.resolve(t+"/",r):t+r,r+this.query.toString(this.token)+this.fragment.toString()},r.prototype.equalPath=function(t){return this.path.get()===t},r.prototype.equal=function(t){return this.query.equal(t.query)&&this.equalPath(t.path.get())},r.prototype.equalWithFragment=function(t){return this.equal(t)&&this.fragment.equal(t.fragment)},r.prototype.getQuery=function(){return this.query.get()},r.prototype.getPath=function(){return this.path.get()
},r}),define("sfr/router/router/config",[],{path:"/",root:"",mode:"async"}),define("sfr/router/router/controller",["require","sfr/router/lang/extend","sfr/router/router/URL","sfr/router/router/config"],function(t){function r(t,r){e(t,r)||(s(t,r),a=t)}function e(t,r){return a&&t.equal(a)&&!r.force}function n(t){var r=p.root;if("/"===t.charAt(0)&&r)if(0===t.indexOf(r))t=t.replace(r,"");else{var e=r.split("/").slice(1);e=e.map(function(){return".."}),t=e.join("/")+t,a=null}return t}function o(t,r){return t||(t=n(location.pathname)),new c(t,{query:r,base:a})
}function i(t,e){t=t||{};var i=n(location.pathname);if(location.search.length>1&&(i+=location.search),i=o(i),i.outRoot)return u(i.toString(),!0);var s=e?{src:"sync"}:f({src:"history"},t.state);r(i,s)}function u(t,r){h.dispose(),r?location.replace(t):location.href=t}var s,a,f=t("sfr/router/lang/extend"),c=t("sfr/router/router/URL"),p=t("sfr/router/router/config"),h={};return h.init=function(t){window.addEventListener("popstate",i,!1),s=t,i(null,!0)},h.redirect=function(t,n,i){return i=i||{},t=o(t,n),t.outRoot||"page"===p.mode?!e(t,i)&&u(t.toString()):(a.equalWithFragment(t)||i.silent||history.pushState(i,i.title,t.toString()),void r(t,i))
},h.reset=function(t,n,i){return i=i||{},t=o(t,n),t.outRoot||"page"===p.mode?!e(t,i)&&u(t.toString()):(i.silent?a=t:r(t,i),void history.replaceState(i,i.title,t.toString()))},h.dispose=function(){window.removeEventListener("popstate",i,!1),a=null},h}),define("sfr/router/router",["require","sfr/router/lang/extend","sfr/router/router/config","sfr/router/router/controller"],function(t){function r(t){var r=-1;return t=t.toString(),p.some(function(e,n){return e.raw.toString()===t&&(r=n),-1!==r}),r}function e(t,r){for(var e,n={},o=r.params||[],i=t.match(r.path)||[],u=1;u<i.length;u++)e=o[u-1]||"$"+u,n[e]=decodeURIComponent(i[u]);
return n}function n(t,r){function o(){if(l=!1,u){var t=s({},u);u=null,n(t.url,t.options)}}if(r=r||{},l)return void(u={url:t,options:r});l=!0;var i,a,f=s({},t.getQuery()),c={},d=t.getPath();if(p.some(function(r){return r.path instanceof RegExp?r.path.test(d)&&(i=r,c=e(d,r)):t.equalPath(r.path)&&(i=r),r.path||(a=r),!!i}),i=i||a,!i)throw u=null,l=!1,new Error("can not found route for: "+d);r.title&&(document.title=r.title);var g={path:d,pathPattern:i.raw,query:f,params:c,url:t.toString(),options:r},m=[g,h];
h=g,i.fn.length>m.length?(m.push(o),i.fn.apply(i.thisArg,m)):(i.fn.apply(i.thisArg,m),o())}function o(t){var r={params:[]};return r.path=t.replace(/:([^\/]+)/g,function(t,e){return r.params.push(e),"([^/]+)"}),r.path=new RegExp("^"+r.path+"$"),r}function i(t,r,e){var n={raw:t,path:t,fn:r,thisArg:e};!(t instanceof RegExp)&&t.indexOf(":")>=0&&(n=s(n,o(t))),p.push(n)}var u,s=t("sfr/router/lang/extend"),a=t("sfr/router/router/config"),f=t("sfr/router/router/controller"),c={},p=[],h={},l=!1;return c.reset=function(t,r,e){f.reset(t,r,e)
},c.config=function(t){t=t||{};var r=t.root;r&&"/"===r.charAt(r.length-1)&&(r=t.root=r.substring(0,r.length-1)),r&&"/"!==r.charAt(0)&&(t.root="/"+r),s(a,t)},c.add=function(t,e,n){if(r(t)>=0)throw new Error("path already exist");i(t,e,n)},c.remove=function(t){var e=r(t);e>=0&&p.splice(e,1)},c.exist=function(t){return r(t)>=0},c.clear=function(){p=[]},c.redirect=function(t,r,e){f.redirect(t,r,e)},c.start=function(t){c.config(t),f.init(n)},c.stop=function(){f.dispose(),c.clear(),u=null,h={}},c.controller=function(t){f=t
},c.getState=function(){return h},c}),define("sfr/router/uri",["require","sfr/router/uri/URI","sfr/router/uri/util/uri-parser","sfr/router/uri/component/Path"],function(t){var r=t("sfr/router/uri/URI"),e=function(t){return new r(t)};return e.parse=t("sfr/router/uri/util/uri-parser"),e.resolve=t("sfr/router/uri/component/Path").resolve,e}),define("sfr/router/uri/URI",["require","sfr/router/uri/util/uri-parser","sfr/router/uri/component/Scheme","sfr/router/uri/component/UserName","sfr/router/uri/component/Password","sfr/router/uri/component/Host","sfr/router/uri/component/Port","sfr/router/uri/component/Path","sfr/router/uri/component/Query","sfr/router/uri/component/Fragment"],function(t){function r(t){t=n(t);
var r,e=this;Object.keys(o).forEach(function(n){r=o[n],e[n]=new r(t[n])})}function e(t){var r=[],e=t.username.toString(),n=t.password.toString(),o=t.host.toString(),i=t.port.toString();return(e||n)&&r.push(e+":"+n+"@"),r.push(o),r.push(i),r.join("")}var n=t("sfr/router/uri/util/uri-parser"),o={scheme:t("sfr/router/uri/component/Scheme"),username:t("sfr/router/uri/component/UserName"),password:t("sfr/router/uri/component/Password"),host:t("sfr/router/uri/component/Host"),port:t("sfr/router/uri/component/Port"),path:t("sfr/router/uri/component/Path"),query:t("sfr/router/uri/component/Query"),fragment:t("sfr/router/uri/component/Fragment")};
...
},c.remove=function(t){return p.delete(t)},c.exist=function(t){return p.has(t)},c.clear=function(){p.clear(),u.clear()},c.redirect=function(t,r,e){u.redirect(t,r,e)},c.back=function(){h=!0,history.back()},c.reset=function(t,r,e){u.reset(t,r,e)},c.start=function(){o(n)},c.update=function(t,r,e,n){e=e?e:{},e.hasOwnProperty("silent")||(e.silent=!0);var o=location.href.replace(/.*\/([^\/]+$)/,"/$1"),i=location.pathname.replace(/.*\/([^\/]+$)/,"/$1"),s=u.getState();if(!p.has(i))throw new Error("service not found:"+i);
var a=p.get(i),f={from:{url:o},to:{url:t,path:i},extra:n};a.update(s,f),u.reset(t,r,e)},c}),define("sfr/service",["require"],function(){var t=function(){};return t.prototype.create=function(){},t.prototype.attach=function(){},t.prototype.detach=function(){},t.prototype.destroy=function(){},t.prototype.update=function(){},t}),define("sfr/resource",["sfr/utils/http","sfr/utils/underscore"],function(t,r){function e(t){this.url=t}return e.prototype={getUrl:function(t){var e=this.url;return r.forOwn(t,function(t,r){e=e.replace(":"+r,t)
}),e=e.replace(/:[a-zA-Z]\w*/g,"")},create:function(r,e){var n=this.getUrl(e);return t.post(n,r)},query:function(r){var e=this.getUrl(r);return t.get(e)},update:function(r,e){var n=this.getUrl(e);return t.put(n,r)},"delete":function(r){var e=this.getUrl(r);return t.delete(e)}},e}),define("sfr/view",["require"],function(){var t=function(){this._init()};return t.prototype={_init:function(){},set:function(){},get:function(){},create:function(){},render:function(){},update:function(){},attach:function(){},detach:function(){},destroy:function(){},on:function(){},off:function(){}},t
