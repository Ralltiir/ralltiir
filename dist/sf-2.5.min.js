...
},c.add=function(t,e,n){if(r(t)>=0)throw new Error("path already exist");i(t,e,n)},c.remove=function(t){var e=r(t);e>=0&&p.splice(e,1)},c.exist=function(t){return r(t)>=0},c.clear=function(){p=[]},c.redirect=function(t,r,e){f.redirect(t,r,e)},c.start=function(t){c.config(t),f.init(n)},c.stop=function(){f.dispose(),c.clear(),u=null,h={}},c.controller=function(t){f=t},c.getState=function(){return h},c}),define("sfr/router/uri",["require","sfr/router/uri/URI","sfr/router/uri/util/uri-parser","sfr/router/uri/component/Path"],function(t){var r=t("sfr/router/uri/URI"),e=function(t){return new r(t)
