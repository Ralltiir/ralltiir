...
}function r(t){return Object.keys(t)}function e(t,r){t=t||{};for(var e in t)if(t.hasOwnProperty(e)&&r(t[e],e,t)===!1)break;return t}function n(t){return t?S.slice.call(t):[]}function o(r){var e=t(arguments);return S.forEach.apply(r||[],e)}function i(r,n){if(p(r)){var o=[];return e(r,function(){o.push(n.apply(null,arguments))}),o}var i=t(arguments);return S.map.apply(r||[],i)}function u(r){var e=t(arguments);return S.slice.apply(r||[],e)}function s(r){var e=t(arguments);return S.splice.apply(r||[],e)
}function a(r){var e=t(arguments);return x.split.apply(r||"",e)}function f(r){return t(arguments).reduce(function(t,r){return t.replace("%s",r)},r)}function c(){return d.apply(null,u(arguments,0).reverse())}function p(t){return null!==t&&"object"==typeof t}function h(t){return t instanceof String||"string"==typeof t}function l(t){return t instanceof RegExp}function d(t){t=null==t?{}:t;var r=u(arguments,1);return o(r,function(r){y(t,r)}),t}function g(t,r){return t?void e(r,function(r,e){return p(r)&&p(t[e])?g(t[e],r):void(t[e]=r)
}):t}function y(t,r){return t?(e(r,function(r,e){t[e]=r}),t):t}function m(){var t={},r=u(arguments,0).reverse();return o(r,function(r){g(t,r)}),t}function v(t){var r={};return i(t,function(t){var e=t[0],n=t[1];r[e]=n}),r}function w(t){return t instanceof Array}function b(t){return w(t)?0===t.length:!t}function q(t){return function(){return!t.apply(null,arguments)}}function _(t){var r=u(arguments);return function(){var e=[0,0];e.push(r);var n=S.splice.apply(arguments,e);return t.apply(null,n)}}function A(t){var r=u(arguments);
return r.shift(),function(){var e=u(arguments),n=[e,arguments.length,0].concat(r);return s.apply(null,n),t.apply(null,e)}}var j={},S=Array.prototype,x=(Object.prototype,String.prototype);return j.keysIn=r,j.forOwn=e,j.assign=d,j.merge=d,j.extend=d,j.defaults=c,j.defaultsDeep=m,j.fromPairs=v,j.slice=u,j.splice=s,j.forEach=o,j.map=i,j.toArray=n,j.split=a,j.format=f,j.isArray=w,j.isEmpty=b,j.isString=h,j.isObject=p,j.isRegExp=l,j.partial=_,j.partialRight=A,j.negate=q,j}),define("sfr/utils/promise",["require","sfr/utils/underscore"],function(t){function r(t){if(!(this instanceof r))throw"Promise must be called with new operator";
if("function"!=typeof t)throw"callback not defined";this._state=n,this._result,this._fulfilledCbs=[],this._rejectedCbs=[];var e=this;setTimeout(function(){e._doResolve(t)})}function e(t){return t&&"function"==typeof t.then}var n=(t("sfr/utils/underscore"),0),o=1,i=2,u={longStackTraces:!1};return r.prototype._fulfill=function(t){this._result=t,this._state=o,this._flush()},r.prototype._reject=function(t){u.longStackTraces&&t&&(t.stack+="\n"+this._originalStack),this._result=t,this._state=i,this._flush()
},r.prototype._resolve=function(t){e(t)?this._doResolve(t.then.bind(t)):this._fulfill(t)},r.prototype._doResolve=function(t){var r=!1,e=this;try{t(function(t){r||(r=!0,e._resolve(t))},function(t){r||(r=!0,e._reject(t))})}catch(n){if(r)return;r=!0,e._reject(n)}},r.prototype._flush=function(){if(this._state!==n){var t=this._state===i?this._rejectedCbs:this._fulfilledCbs,r=this;t.forEach(function(t){"function"==typeof t&&t(r._result)}),this._rejectedCbs=[],this._fulfilledCbs=[]}},r.prototype._done=function(t,r){this._fulfilledCbs.push(t),this._rejectedCbs.push(r),this._flush()
},r.prototype.then=function(t,e){var n,o=this;return new r(function(r,i){o._done(function(e){if("function"==typeof t){try{n=t(e)}catch(o){return i(o)}r(n)}else r(e)},function(t){if("function"==typeof e){try{n=e(t)}catch(o){return i(o)}r(n)}else i(t)})})},r.prototype.catch=function(t){return this.then(function(t){return t},t)},r.prototype.finally=function(t){return this.then(t,t)},r.resolve=function(t){return e(t)?t:new r(function(r){return r(t)})},r.reject=function(t){return new r(function(r,e){e(t)
})},r.all=function(t){return new r(function(e,n){var o=t.map(function(){return void 0}),i=0;t.map(r.resolve).forEach(function(r,u){r.then(function(r){o[u]=r,i++,i===t.length&&e(o)},n)})})},r.mapSeries=function(t,e){var n=r.resolve("init"),o=[];return t.forEach(function(r,i){n=n.then(function(){return e(r,i,t)}).then(function(t){return o.push(t)})}),n.then(function(){return o})},r}),define("sfr/utils/assert",["require"],function(){function t(t,r){if(!t)throw new Error(r)}return t}),define("sfr/utils/map",["require","sfr/utils/underscore"],function(t){function r(){this.size=0,this._data={}
}function e(t){return n.isRegExp(t)?"reg_"+t:n.isString(t)?"str_"+t:"other_"+t}var n=t("sfr/utils/underscore");return r.prototype.set=function(t,r){t=e(t),this._data.hasOwnProperty(t)||(this._data[t]=r,this.size++)},r.prototype.has=function(t){return t=e(t),this._data.hasOwnProperty(t)},r.prototype.delete=function(t){t=e(t),this._data.hasOwnProperty(t)&&(delete this._data[t],this.size--)},r.prototype.get=function(t){return t=e(t),this._data[t]},r.prototype.clear=function(){this.size=0,this._data={}
},r}),define("sfr/action",["require","sfr/router/router","sfr/utils/promise","sfr/utils/assert","sfr/utils/map","sfr/utils/underscore"],function(t){function r(t){return"object"==typeof t&&t.create&&t.attach&&t.detach&&t.destroy&&t.update?!0:!1}function e(t,r){var e=r.getAttribute("data-sf-href"),n=r.getAttribute("data-sf-options");if(e){try{n=JSON.parse(n)||{}}catch(o){n={}}n.src="hijack",f.redirect(e,null,n),t.preventDefault()}}function n(t){function r(t,r){for(var e=t;null!==e&&e.tagName!==r.toUpperCase();)e=e.parentNode;
return e}document.documentElement.addEventListener("click",function(e){e=e||window.event;var n=r(e.target||e.srcElement,"A");n&&t(e,n)},!1)}var o,i=t("sfr/router/router"),u=t("sfr/utils/promise"),s=t("sfr/utils/assert"),a=t("sfr/utils/map"),f=(t("sfr/utils/underscore"),{}),c=new a,p=!1;return f.regist=function(t,e){s(t,"illegal action url"),s(r(e),"illegal service, make sure to extend from sfr/service"),s(!c.has(t),"path already registerd"),i.add(t,this.dispatch),c.set(t,e)},f.dispatch=function(t,r){var e=c.get(t.pathPattern),n=c.get(r.pathPattern);
return t.options=t.options||{},p&&(t.options.src="back",p=!1),u.mapSeries([n&&n.detach.bind(n),e&&e.create.bind(e),r.url!==o&&n&&n.destroy.bind(n),e&&e.attach.bind(e)],function(e){return"function"==typeof e?e(t,r):void 0}).catch(function(t){setTimeout(function(){throw t})})},f.remove=function(t){return c.delete(t)},f.exist=function(t){return c.has(t)},f.clear=function(){c.clear(),i.clear()},f.redirect=function(t,r,e){i.redirect(t,r,e)},f.back=function(){p=!0,history.back()},f.reset=function(t,r,e){i.reset(t,r,e)
},f.start=function(){n(e)},f.update=function(t,r,e,n){e=e?e:{},e.hasOwnProperty("silent")||(e.silent=!0);var o=location.href.replace(/.*\/([^\/]+$)/,"/$1"),u=location.pathname.replace(/.*\/([^\/]+$)/,"/$1");if(c.has(u)){var s=c.get(u);s.update({path:u,url:t,prevUrl:o,query:r,options:e,container:n.container,view:n.view})}i.reset(t,r,e)},f}),define("sfr/service",["require"],function(){var t=function(){};return t.prototype.create=function(){},t.prototype.attach=function(){},t.prototype.detach=function(){},t.prototype.destroy=function(){},t.prototype.update=function(){},t
}),define("sfr/resource",["sfr/utils/http","sfr/utils/underscore"],function(t,r){function e(t){this.url=t}return e.prototype={getUrl:function(t){var e=this.url;return r.forOwn(t,function(t,r){e=e.replace(":"+r,t)}),e=e.replace(/:\w+/g,"")},create:function(r,e){var n=this.getUrl(e);return t.post(n,r)},query:function(r){var e=this.getUrl(r);return t.get(e)},update:function(r,e){var n=this.getUrl(e);return t.put(n,r)},"delete":function(r){var e=this.getUrl(r);return t.delete(e)}},e}),define("sfr/view",["require"],function(){var t=function(){this._init()
};return t.prototype={_init:function(){},set:function(){},get:function(){},create:function(){},render:function(){},update:function(){},attach:function(){},detach:function(){},destroy:function(){},on:function(){},off:function(){}},t});