...
参看《[卡片开发教程](http://sfe.baidu.com/sf/main.html#./doc_new/2_guides/2_dev_guied/1_dev_card/0.introduce.md)》
...
参看《[应用服务开发教程](http://sfe.baidu.com/sf/main.html#./doc_new/2_guides/2_dev_guied/2_dev_service/service.md)》

参看《[应用服务接入规范](http://sfe.baidu.com/sf/main.html#./doc_new/2_guides/2_dev_guied/2_dev_service/service-standard.md)》
...
参看《[JS模块开发教程](http://sfe.baidu.com/sf/main.html#./doc_new/2_guides/2_dev_guied/3_dev_act/act.md)》
